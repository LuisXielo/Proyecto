...
public class MainActivityNivel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (vidas == 3){
           // iv_vidas.setImageResource(R.drawable."nombre de la foto de 3 vida");
        }
        if (vidas == 2){
            // iv_vidas.setImageResource(R.drawable."nombre de la foto de 2 vida");
        }
        if (vidas == 1){
            // iv_vidas.setImageResource(R.drawable."nombre de la foto de 1 vida");
        }
    ...
    public void NumAleatorio(){
        if(score <= 19){
            ...
            Intent intent = new Intent(this, MainActivityNivel3.class);
